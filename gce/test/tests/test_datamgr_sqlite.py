...
from gce.main.datamgr import DataMgr, MAX_NUMERICAL_LIMIT, MAX_TEXT_LENGTH
...
class TestDataMgrSQLite(unittest.TestCase):
    ...
    def test_rate_limit_spec_parsing_and_enablement(self):
        ...
        from gce.main.datamgr import parse_rate_limit_spec, is_control_enabled, RMSLimitRule
